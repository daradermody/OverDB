...
export type GetPersonInfoQuery = { __typename?: 'Query', person: { __typename?: 'Person', id: string, profilePath?: string | null, name: string, knownForDepartment: string, biography: string, favourited: boolean } };
