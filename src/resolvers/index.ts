...
import {
  ...
  type MutationDeleteListsArgs,
  type MutationEditListArgs,
  type MutationSetFavouriteArgs,
  type MutationSetInWatchlistArgs,
  type MutationSetSentimentArgs,
  type MutationSetWatchedArgs,
  type MutationUpdateUserSettingsArgs,
  type PaginatedMovies,
  type PaginatedPeople,
  type PersonInfo,
  type PersonWithoutFav,
  type QueryCastForMovieArgs,
  type QueryCreditsForPersonArgs,
  type QueryCrewForMovieArgs,
  type QueryMovieArgs,
  type QueryPersonArgs,
  type QueryRecommendedMoviesArgs,
  type QuerySearchArgs,
  type QueryStreamingProvidersArgs,
  type QueryTrendingArgs,
  type QueryUserArgs,
  type ResolverFn,
  type Resolvers,
...
import {type StoredList, UserData} from '../services/UserData'
import {getUser, getUsers, type User} from '../services/users'
...
function requiresLogin<TResult, TParent, TContext extends {
  user?: User
}, TArgs>(resolver: ResolverFn<TResult, TParent, TContext & {
  user: User
}, TArgs>): ResolverFn<TResult, TParent, TContext, TArgs> {
...
function requiresAdmin<TResult, TParent = {}, TContext extends {
  user?: User
} = {}, TArgs = {}>(resolver: ResolverFn<TResult, TParent, TContext, TArgs>): ResolverFn<TResult, TParent, TContext, TArgs> {
