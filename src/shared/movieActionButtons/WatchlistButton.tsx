...
import {Movie, useSetInWatchlistMutation} from "../../../server/generated/graphql";
  ...
  return (
    ...
    >
      <Button sx={{color: 'common.white'}} onClick={handleClick}>
        {inWatchlist ? <AlarmOn color="primary" style={{padding: '6px 12px 6px 4px'}}/> : <AlarmAdd style={{padding: '6px 12px 6px 4px'}}/>}
