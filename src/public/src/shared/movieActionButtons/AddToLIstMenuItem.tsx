...
import {type List, ListType, type Movie} from '../../../../apiTypes.ts'
...
function AddToListDialog({movieId, onClose}: { movieId: Movie['id'], onClose: () => void }) {
  ...
  const {mutate: addToList, isPending: addToListLoading, error: addToListError} = useMutation(trpc.addToList.mutationOptions())
